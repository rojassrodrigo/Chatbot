...
<div>
  <button
    className='text-xl rounded-full bg-blue-800 w-8 h-8 absolute -right-4 -top-5'
    onClick={() => toggleCollapsed(true)}
  >
    x
  </button>

  <div className='flex flex-col gap-4 mx-4 md:mx-auto md:max-w-lg border border-gray-400 p-4 rounded-md'>
